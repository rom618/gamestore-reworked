...
public class TransactionResponseDto {
    ...
    public TransactionResponseDto(Transaction model) {
        ...
        userAgreementCheck = model.getUserAgreementCheck();
        if (model.getPaymentInformation() != null) {
            setPaymentInformation(new PaymentInformationResponseDto(model.getPaymentInformation()));
        }
        if (model.getCustomerAccount() != null) {
            setCustomerAccount(new CustomerAccountResponseDto(model.getCustomerAccount()));
        }
        if (model.getAddress() != null) {
            setAddress(new AddressResponseDto(model.getAddress()));
        }
    }
